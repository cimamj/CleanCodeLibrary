namespace CleanCodeLibrary.Domain.Common.Validation.ValidationItems
{
    public static partial class ValidationItems
    {
        public static class Book
        {
            ...
            public static readonly ValidationItem AccessDenied = new ValidationItem
            {
                Code = $"{CodePrefix}.AccessDenied",
                Message = "Nemate administratorska prava za ovu akciju.",
                ValidationSeverity = ValidationSeverity.Error,
                ValidationType = ValidationType.BussinessRule
            };

            public static readonly ValidationItem ExternalBookNotFound = new ValidationItem
            {
                Code = $"{CodePrefix}.ExternalBookNotFound",
