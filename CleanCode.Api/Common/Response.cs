...
namespace CleanCode.Api.Common
{
    ...
    {
        private IReadOnlyList<ValidationResultItem> _info
        {
            get; init;
        }

        private IReadOnlyList<ValidationResultItem> _errors
        {
            get; init;
        }

        private IReadOnlyList<ValidationResultItem> _warnings
        {
            get; init;
        }
